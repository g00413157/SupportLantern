...
2. John Smith
   ...
   Description: Johns emails are stuck in the Outbox. SMTP error displayed.  
   Priority: Medium  
   Status: In Progress  
...
VALUES 
('Computer Wont Start', 'Alice Johnson reports that her desktop computer is unresponsive after pressing the power button.', 1, 1, 1),
('Email Not Sending', 'John Smiths emails are stuck in the Outbox. SMTP error displayed.', 2, 2, 2),
...
('Monitor Display Flickering', 'James Taylors screen flickers intermittently when using the docking station.', 9, 2, 1),
('Shared Drive Access Denied', 'Isabella Martinez cannot access shared folders on the network.', 10, 2, 2),
('Malware Detected on PC', 'David Thompsons antivirus flagged malware during a routine scan.', 11, 1, 1),
...
('Database Access Request', 'Liam Hall requires access to the companies internal database as a new hire.', 17, 2, 1),
